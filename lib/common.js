...
PaymentProtocol.LEGACY_PAYMENT.XMCC.REQUEST_CONTENT_TYPE = 'application/monoeci-paymentrequest';
PaymentProtocol.LEGACY_PAYMENT.XMCC.CONTENT_TYPE = 'application/monoeci-payment';
PaymentProtocol.LEGACY_PAYMENT.XMCC.ACK_CONTENT_TYPE = 'application/monoeci-paymentack';
...
PaymentProtocol.prototype.makePaymentRequest = function(obj, currency) {
  ...
  this.currency = this.currency || currency || 'XMCC';
  this.setObj(obj);
  return this;
};
